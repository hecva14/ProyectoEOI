<%-- 
    Document   : WOMAN
    Created on : 4 jul. 2020, 18:14:54
    Author     : Usuario
--%>
...
<html>
 ...
 <body class="woman">
        <header class="header">
            <nav class="navegador">
                <div class="ropa">
                    ...
                    <form class="form_woman" action="/ProyectoEOI/CarritoServlet" method="post">
                        <%
       ...
       <br><br><br><br><br>
          <h2><span>Seccion de mujer</span></h2>
          
          <form class="form_woman" action="/ProyectoEOI/WOMAN.jsp" method="post">
              <% 
                  ArrayList<Producto> lista = new ArrayList();
                     Conexion con= new Conexion();
                  
			try {
				lista = con.consultarMujer();
