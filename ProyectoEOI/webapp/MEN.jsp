<%-- 
    Document   : MEN
    Created on : 10 jul. 2020, 10:39:52
    Author     : Usuario
--%>
        ...
        <header class="header">
            <nav class="navegador">
                <div class="ropa">
                    ...
                    <form class="form_men" action="/ProyectoEOI/CarritoServletH" method="post">
                        <%
          ...
          <h2><span>Seccion de Hombre</span></h2>
          
          <form class="form_men" action="/ProyectoEOI/MEN.jsp" method="post">
              <% 
                  ArrayList<Producto> lista = new ArrayList();
                     Conexion con= new Conexion();
                  
			try {
				lista = con.consultarHombre();
